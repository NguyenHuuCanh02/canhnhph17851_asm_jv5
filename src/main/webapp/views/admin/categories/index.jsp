		...
		<article class="row col-11">
			<div class="table-responsive col-10 offset-1">
				<a class="btn btn-success"
					href="/SOF3021_Assignment_Canhnhph17851/admin/categories/create">
					Create </a>
				<table class="table">
					<thead>
						<tr>
						...
						<c:forEach items="${ data.content }" var="cate">
							<tr>
								...
								<td><a class="btn btn-primary"
									href="/SOF3021_Assignment_Canhnhph17851/admin/categories/edit/${ cate.id }">
										Update </a></td>
										<td>><a class="btn btn-danger" data-bs-toggle="modal"
								data-bs-target="#exampleModal${ cate.id }"
									...
									<div class="modal-content">
										...
										<div class="modal-footer">
											...
											<a type="button" class="btn btn-primary"
												href="/SOF3021_Assignment_Canhnhph17851/admin/categories/delete/${ cate.id }">Delete</a>
										</div>
									</div>
								</div>
							</div>
					...
					<ul class="pagination">
						<c:forEach var="index" begin="0" end="${ data.totalPages - 1 }">
							<li class="page-item"><a class="page-link"
								href="/SOF3021_Assignment_Canhnhph17851/admin/categories/index?page=${ index }">${ index + 1 }</a>
							</li>
						</c:forEach>
					</ul>
				</div>
