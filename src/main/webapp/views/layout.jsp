...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
		<div class="container-fluid">
			<a class="navbar-brand" href="/SOF3021_Assignment_Canhnhph17851/views/layout.jsp">Trang
				Chủ</a>
						...
						<li class="nav-item dropdown"><a
							...
							<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
								<li><a class="dropdown-item"
									href="/SOF3021_Assignment_Canhnhph17851/admin/accounts/index">Quản lý người
										dùng</a></li>
								<li><a class="dropdown-item"
									href="/SOF3021_Assignment_Canhnhph17851/admin/products/index">Quản lý sản
										phẩm</a></li>
								<li><a class="dropdown-item"
									href="/SOF3021_Assignment_Canhnhph17851/admin/categories/index">Quản lý danh
										mục</a></li>
